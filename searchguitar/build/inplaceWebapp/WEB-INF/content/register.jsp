	 ...
	 <div class="header-bottom">
	    <div class="wrap">
          ...
          <div class="register_account">
          	<div class="wrap">
    	      <h4 class="title">注册新账户</h4>
    		   <form action="Register" method="post">
    			 <div class="col_1_of_2 span_1_of_2">
		   			    <div>姓名:<input type="text" name="name"></input></div>
						<div>性别:<input type="text" name="sex"></input></div>
		    			<div>地址:<input type="text" name="address"></input></div>
		    			<div>邮箱:<input type="text" name="email"></input></div>
