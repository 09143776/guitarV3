		...
		<div class="logoBar">
			<div class="comWidth">
				...
				<div class="shopCar fr">
					<span href="cart2" class="shopText fl">购物车</span> <span
						class="shopNum fl">0</span>
				</div>
			</div>
		</div>
	</div>
			...
			<tbody>
				...
				<tr>
					...
					<td class="items"><img src="images/<%=cart.getPicture()%>"
						width="200" height="160" alt="" /><span><%=cart.getPname()%></span></td>
					<td class="price"><%=cart.getPrice()%></td>
					<td class="count"><span class="reduce">-</span> 
					<input class="count-input" type="text" name="number<%=cart.getNum()%>" 
					value="<%=cart.getNum()%>" />
