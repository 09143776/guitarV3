...
<body>
	<h2 align="center">后台管理：添加商品 <a href="index"> 返回主页</a></h2>
	<p align="center">请根据数据库输出的商品添加商品</p>
	...
	<div class="easyui-panel" title="添加商品" style="width:400px;padding:30px 60px">
		...
		<div style="margin-bottom:20px">
		<div>图片1</div>
			<input class="easyui-textbox"  name="picture1" style="width:100%;height:32px">
		</div>
		<div style="margin-bottom:20px">
		<div>图片2</div>
			<input class="easyui-textbox"  name="picture2" style="width:100%;height:32px">
		</div>	
