...
<html>
<head>
<title>Login<s:text name="loginPage"/></title>
        ...
        <div class="login">
          	<div class="wrap">
				<div class="col_1_of_login span_1_of_login">
					...
					<div class="button1">
					   <a href="register.html"><input type="submit" name="Submit" value="注册"></a>
				  </div>
					 <div class="clear"></div>
				</div>
				<div class="col_1_of_login span_1_of_login">
						  ...
						  <fieldset class="input">
						    <div class="remember">
							    <p id="login-form-remember">
							      <label for="modlgn_remember"><a href="#">忘记登录密码? </a></label>
							   </p>
							    <input type="submit" name="Submit" class="button" value="登录"><div class="clear"></div>
							 </div>
						  </fieldset>
	<form action="Login" method="post">
	         <div>用户名：<input type="text" name="name"></input></div>
