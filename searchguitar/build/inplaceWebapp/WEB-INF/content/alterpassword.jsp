	 ...
	 <div class="header-bottom">
	    <div class="wrap">
          ...
          <div class="register_account">
          	<div class="wrap">
    	      <h4 class="title">忘记密码，请修改</h4>
    		   <form action="Alter" method="post">
    			 <div class="col_1_of_2 span_1_of_2">
		   			    <div>姓名&nbsp;:<input type="text" name="name"></input></div>
		    			<div>旧密码:<input type="text" name="oldpassword"></input></div>
		    			<div>新密码:<input type="text" name="newpassword"></input></div>
		    	 </div>
		    	  <p>&nbsp;</p>
		    	  <p>&nbsp;</p>
		    	  <p>&nbsp;</p>
		...
		<div class="footer-top">
			<div class="wrap">
			  <div class="section group example">
				...
				<div class="col_1_of_2 span_1_of_2">
					<ul class="f-list">
					  <li><img src="images/3.png"><span class="f-text">我们向您承诺七天无理由退换</span><div class="clear"></div></li>
					</ul>
				</div>
				<div class="clear"></div>
		      </div>
